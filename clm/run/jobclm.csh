...
#-------------------------------------------------------
set CASE_NAME   = 2000_1_6           	# case name                                            <MARK #1>
...
set END_DAY     = 3             	# model end Julian day
...
set TIMESTEP    = 3600.         	# model time step
...
# inputdata directory
setenv DAT_ROOT   /lm99/inputdata                             # <MARK #4>
setenv DAT_RAWDIR /lm99/CLMrawdata         
...
# case directory
#-------------------------------------------------------
setenv CAS_ROOT   /lm99/cases                                         # <MARK #5>
...
#define	OPENMP 28                 !
#define NETCDF                    ! <--- 1. 开启 NetCDF 格式输出
#define BGC
#define BGC                       ! <--- 2. 开启生物地球化学(碳)循环
EOF
